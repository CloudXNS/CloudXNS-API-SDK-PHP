 ...
 * @return string
 */
$api->record->recordList(2125, 0, 0, 30);
 ...
 * @return string
 */
$api->record->spareAdd(2125, 295169, 629119, '192.168.100.222');
 ...
 * @return string
 */
$api->record->recordUpdate(2125, 'www', '192.168.100.210', 'AX', 55, 600, 1, 42693);
 ...
 * @param integer $domainId 域名ID
 */
$api->record->recordDelete(629119, 2125);
